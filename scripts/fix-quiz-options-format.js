/**
 * Script de migration pour corriger le format des options dans les quiz (Backend Principal)
 * 
...
const fixQuizOptionsFormat = async () => {
  try {
    console.log('🔄 Début de la migration des options de quiz (Backend Principal)...');
